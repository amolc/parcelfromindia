...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.doLogin = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseurl + "auth/loginUser/" + _this.params.project_id, _this.params).subscribe(function (result) {
                console.log(result, "result");
